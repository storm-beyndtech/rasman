		...
		<>
			...
			<nav
				className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 navbar-container border-b border-transparent ${
					scrolled ? "bg-black/10 backdrop-blur-xl border-white/10 shadow-2xl" : "bg-transparent"
				}`}
			>
				...
				<AnimatePresence>
					{isOpen && (
						<motion.div
							...
							className="absolute top-full right-4 mt-2 w-80 bg-black/20 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-[60]"
						>
